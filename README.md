...
```
ChicagoPassing/
├── data/               # Parquet files generated by ETL (not tracked in git)
├── etl/
│   ├── etl.ipynb       # Data extraction, transformation, and loading
│   └── README.md       # Data dictionary and ER diagram
├── images/             # Generated plots and figures
├── src/
│   ├── main.ipynb      # Analysis notebook (EDA, modeling, results)
│   └── utils.py        # Shared helper functions (prediction, baseline computation)
├── README.md           # This file
